...
import com.example.socialshout.Model.addVideo_Model;
import com.example.socialshout.databinding.ActivityAddVideoBinding;

public class addVideo_Controller extends AppCompatActivity {

    // binding
    ActivityAddVideoBinding bind_addVideo;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bind_addVideo = ActivityAddVideoBinding.inflate(getLayoutInflater());
