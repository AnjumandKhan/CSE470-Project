...
import com.example.socialshout.Model.userProfile_Model;
import com.example.socialshout.R;
import com.example.socialshout.databinding.ActivityUserProfileControllerBinding;
    ...
    protected void onStart() {
        ...
        databaseReference.child(userId).addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if(snapshot.exists()){
                    bind_userProfile.userNameTxt.setText("User Name: "+snapshot.child("uName").getValue().toString());
